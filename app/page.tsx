        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            ...
            <p className="text-lg text-zinc-400 max-w-lg leading-relaxed font-sans border-l-2 border-blue-600 pl-6">
              Dünyanın en hafif görev protokolü. Tamamladığın her görev sana puan kazandırır, kazandığın puanlar arayüzünü modifiye etmeni sağlar.
            </p>

            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
              <button className="px-10 py-5 bg-blue-600 text-white font-black text-xs tracking-widest hover:bg-blue-500 transition-all transform hover:-translate-y-1 shadow-[0_0_30px_rgba(37,99,235,0.3)]">
                GET_TICKO.BETA
              </button>
              <div className="flex flex-col justify-center px-6 py-4 border border-white/10 bg-white/5">
                <span className="text-[9px] text-zinc-500 uppercase tracking-widest">Global Status</span>
                <span className="text-green-400 text-xs font-bold font-mono">327 / 1000 SLOTS AVAILABLE</span>
              </div>
            </div>
          </div>

          {/* Yazılımsal Telefon Mockup */}
          <div className="relative group">
            ...
            <div className="relative w-[320px] h-[640px] bg-[#0a0a0a] border-[10px] border-[#1a1a1a] rounded-[3.5rem] shadow-2xl p-8 space-y-8 mx-auto">
              ...
              <div className="bg-blue-600/10 border border-blue-500/20 p-5 rounded-2xl">
                ...
                <p className="text-sm font-bold text-white mb-4">Kodlama Tamamlanacak</p>
              ...
              <div className="bg-zinc-900/50 border border-white/5 p-4 rounded-xl text-center">
                <p className="text-green-400 font-bold text-[10px] animate-bounce">+ 50 POINTS EARNED</p>
